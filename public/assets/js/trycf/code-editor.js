...
.directive('codeEditor',function($timeout){
	...
	'	    <button class="submit-code btn btn-lg {{runBtnClass || \'btn-primary\'}} pull-left">Run Code <i class="icon-play icon-white"></i></button>'+
	...
	'		<button class="toggle-fullscreen btn btn-lg {{fullscreenbtnclass}} pull-right" ng-click="toggleFullscreen()"> <i class="icon-resize-full glyphicon glyphicon-resize-full"></i></button>'+
	'	    <button ng-hide="showOptions == false || showOptions == 0" class="editor-options btn btn-lg btn-default {{optionsbtnclass}} pull-right"> <i class="icon-gear glyphicon glyphicon-cog"></i></button>'+
